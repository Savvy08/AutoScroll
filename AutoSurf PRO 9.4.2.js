...
(function () {
    ...
    let {
        siteList, minTime, maxTime, clickCooldown,
    ...
    panel.innerHTML = `
        <style>
            ...
            #autosurf-header small { color:#888; font-size:11px; cursor:pointer; margin-right:8px; }
        ...
        <div id="autosurf-header">
            <span>AutoSurf PRO 9.4.2 Beta</span>
    ...
    function emulateClick(element) {
        try { element.click(); } catch { if (element.href) window.location.href = element.href; }
    }
    ...
    function tryRandomClick() {
        ...
        emulateClick(element);
        log(`✨ Рандомный клик: ${element.href || element.textContent}`);
    }
